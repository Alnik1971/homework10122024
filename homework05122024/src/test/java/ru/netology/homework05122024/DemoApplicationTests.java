package ru.netology.homework05122024;
...
class DemoApplicationTests {
    ...
    void contextLoadsDev() {
        ...
        ResponseEntity<String> devResponse = restTemplate.getForEntity("http://localhost:" + devapp.getMappedPort(8080) + ENDPOINT, String.class);
    ...
    void contextLoadsProd() {
        ...
        ResponseEntity<String> prodResponse = restTemplate.getForEntity("http://localhost:" + prodapp.getMappedPort(8081) + ENDPOINT, String.class);
